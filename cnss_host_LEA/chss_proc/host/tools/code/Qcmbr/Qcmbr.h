...
#define MBUFFER 2048*2  //1024

#define MCLIENT 4

#define NART_PORT 2391
...
extern int cmd_send2 (void *buf, int len, unsigned char *returnBuf, unsigned int *returnBufSize );
extern unsigned long probe_device( char *dutIP, int dutPort);
extern A_BOOL IsDeviceOpened(void);
