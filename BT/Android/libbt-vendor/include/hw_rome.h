...
#define SOC_VER_QCA206X_20                  0x400c0200 /* QCA206X*/
#define SOC_VER_QCA206X                     0x400c0210 /* QCA206X SEC*/
#define SOC_VER_QCA206X_G                   0x400c1211 /* QCA206X GF*/
#define SOC_VER_QCC207X                     0x40170200

#define QCA9377_RAMPATCH_TLV_1_0_1_PATH      "/vendor/etc/firmware/tfbtfw11.tlv"
#define QCA9377_NVM_TLV_1_0_1_PATH           "/vendor/etc/firmware/tfbtnv11.bin"

#define QCA6698_RAMPATCH_TLV_UART_2_1_PATH   "/vendor/etc/firmware/hpbtfw21.tlv"
#define QCA6698_NVM_TLV_UART_2_1_PATH        "/vendor/etc/firmware/hpnv21.bin"

#define QCA206X_RAMPATCH_TLV_UART_2_0_PATH   "/vendor/etc/firmware/hpbtfw20.tlv"
#define QCA206X_NVM_TLV_UART_2_0_PATH        "/vendor/etc/firmware/hpnv20.bin"

#define QCA206X_RAMPATCH_TLV_UART_2_1_PATH   "/vendor/etc/firmware/hpbtfw21.tlv"
#define QCA206X_NVM_TLV_UART_2_1_PATH        "/vendor/etc/firmware/hpnv21.bin"
#define QCA206X_NVM_TLV_UART_2_1_G_PATH      "/vendor/etc/firmware/hpnv21g.bin"

#define QCC207X_RAMPATCH_TLV_UART_2_0_PATH   "/vendor/etc/firmware/hmtbtfw20.tlv"
#define QCC207X_NVM_TLV_UART_2_0_PATH        "/vendor/etc/firmware/hmtnv20.bin"
...
enum
{
    ...
    HASTINGS_PATCH_VER_0201 = 0x0201,
...
enum
{
    ...
    HASTINGS_SOC_ID_0210 = 0x00000210,
};
...
enum
{
    ...
    HASTINGS_VER_2_1 = ((HASTINGS_PATCH_VER_0201 << 16) | HASTINGS_SOC_ID_0210),
};

#define IS_HASTINGS_SOC(v)                                                                  \
  (((v) == HASTINGS_VER_1_0) || ((v) == HASTINGS_VER_1_0_1) || ((v) == HASTINGS_VER_1_1) || \
   ((v) == HASTINGS_VER_2_0) || ((v) == HASTINGS_VER_2_1))
