...
#ifdef ANDROID_M
#define ROME_RAMPATCH_TLV_3_0_2_PATH    "/etc/firmware/rampatch_tlv_3.2.tlv"
#define ROME_NVM_TLV_3_0_2_PATH         "/etc/firmware/nvm_tlv_3.2.bin"
#define TF_RAMPATCH_TLV_1_0_0_PATH      "/etc/firmware/rampatch_tlv_tf_1.0.tlv"
#define TF_NVM_TLV_1_0_0_PATH           "/etc/firmware/nvm_tlv_tf_1.0.bin"
#define TF_RAMPATCH_TLV_1_0_1_PATH      "/etc/firmware/rampatch_tlv_tf_1.1.tlv"
#define TF_NVM_TLV_1_0_1_PATH           "/etc/firmware/nvm_tlv_tf_1.1.bin"
#else
...
#endif
#define NAPLES_RAMPATCH_TLV_1_0_0_PATH  "/lib/firmware/ar3k/rampatch_tlv_uart_npl_1.0.tlv"
#define NAPLES_NVM_TLV_1_0_0_PATH       "/lib/firmware/ar3k/nvm_tlv_uart_npl_1.0.bin"
#endif
