...
#define CALC_SEG_SIZE(len, max) \
  ((plen) % (max)) ? ((plen / max) + 1) : ((plen) / (max))
...
#define HASTINGS_RAMPATCH_TLV_UART_1_0_PATH "/vendor/firmware/htbtfw10.tlv"
#define HASTINGS_NVM_TLV_UART_1_0_PATH "/vendor/firmware/htnv10.bin"
#define HASTINGS_RAMPATCH_TLV_UART_2_0_PATH "/vendor/firmware/htbtfw20.tlv"
#define HASTINGS_NVM_TLV_UART_2_0_PATH "/vendor/firmware/htnv20.bin"
#else
...
#define ROME_RAMPATCH_TLV_3_0_2_PATH "/home/benne/work/project/tool/quec_bt_tool/firmware/btfw32.tlv"
#define ROME_NVM_TLV_3_0_2_PATH "/home/benne/work/project/tool/quec_bt_tool/firmware/btnv32.bin"
...
#define TF_RAMPATCH_TLV_1_0_1_PATH "./tfbtfw11.tlv"
#define TF_NVM_TLV_1_0_1_PATH "./tfbtnv11.bin"
...
#define HASTINGS_RAMPATCH_TLV_UART_2_0_PATH "htbtfw20.tlv"
#define HASTINGS_NVM_TLV_UART_2_0_PATH "htnv20.bin"

#endif

#define GNO_RAMPATCH_TLV_UART_1_0_PATH "/lib/firmware/image/gnbtfw10.tlv"
#define GNO_NVM_TLV_UART_1_0_PATH "/lib/firmware/image/gnnv10.bin"
#define GNO_RAMPATCH_TLV_UART_2_0_PATH "/lib/firmware/image/gnbtfw20.tlv"
#define GNO_NVM_TLV_UART_2_0_PATH "/lib/firmware/image/gnnv20.bin"
...
/* This header value in rampatch file decides event handling mechanism in the
 * HOST */
...
enum
{
  ...
  GNO_PATCH_VER_0100 = 0x0100,
  GNO_PATCH_VER_0200 = 0x0200,
...
enum
{
  ...
  GNO_SOC_ID_0100 = 0x400B0100,
  GNO_SOC_ID_0200 = 0x400B0200,
...
enum
{
  ...
  HASTINGS_VER_1_0 =
      ((HASTINGS_PATCH_VER_0100 << 16) | (HASTINGS_SOC_ID_0100 & 0x0000ffff)),
  HASTINGS_VER_1_0_1 =
      ((HASTINGS_PATCH_VER_0100 << 16) | (HASTINGS_SOC_ID_0101 & 0x0000ffff)),
  HASTINGS_VER_1_1 =
      ((HASTINGS_PATCH_VER_0100 << 16) | (HASTINGS_SOC_ID_0110 & 0x0000ffff)),
  HASTINGS_VER_2_0 =
      ((HASTINGS_PATCH_VER_0200 << 16) | (HASTINGS_SOC_ID_0200 & 0x0000ffff)),
};
